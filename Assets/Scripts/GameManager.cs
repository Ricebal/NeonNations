...
public class GameManager : NetworkBehaviour
{
    ...
    private void InitGame()
    {
        ...
        m_teamManager.OnPlayersChange += SyncTimeOverClients;
    }

    public void SyncTimeOverClients()
    {
        RpcSyncTimeOverClients(GameMode.TimeLimit);
    }
    ...
    [ClientRpc]
    private void RpcSyncTimeOverClients(float passedTime)
    {
        GameMode.TimeLimit = passedTime;
    }
